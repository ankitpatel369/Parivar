        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayRoleName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SortName = table.Column<string>(type: "nvarchar(3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedDate = table.Column<DateTime>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    Relation = table.Column<string>(type: "nvarchar(250)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Countys_Districts_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePic = table.Column<string>(type: "nvarchar(150)", nullable: true),
                    NoOfMembers = table.Column<int>(nullable: false),
                    AdvanceKills = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResidentAddress = table.Column<string>(type: "nvarchar(300)", nullable: true),
                    ...
                    VillageId = table.Column<long>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Countys_CountyId",
                        column: x => x.CountyId,
                        principalTable: "Countys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Villages_VillageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedDate = table.Column<DateTime>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    MainMemberId = table.Column<long>(nullable: false),
                    ...
                    AdvanceKills = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MosalSurname = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilyMemberDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FamilyMemberDetails_AspNetUsers_MainMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Countys_DistrictId",
                table: "Countys",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_FamilyMemberDetails_MainMemberId",
                table: "FamilyMemberDetails",
                column: "MainMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_FamilyMemberDetails_RelationShipId",
                table: "FamilyMemberDetails",

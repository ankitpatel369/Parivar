...
namespace Parivar.Data.Migrations
{
    ...
    [Migration("20211128052957_UpdateFaUserAndMembersTable")]
    partial class UpdateFaUserAndMembersTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parivar.Data.DbModel.CategoriesMaster", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Parivar.Data.DbModel.FamilyMemberDetails", b =>
                {
                    ...
                    b.Property<string>("MosalVillage")
                        .IsRequired()
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<long?>("RelationShipMasterId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RelationShipMasterId");
            ...
            modelBuilder.Entity("Parivar.Data.DbModel.FamilyMemberDetails", b =>
                {
                    b.HasOne("Parivar.Data.DbModel.CategoriesMaster", "BloodGroup")
                        .WithMany("BloodGroupOfFamilyMember")
                        .HasForeignKey("BloodGroupId");

                    b.HasOne("Parivar.Data.DbModel.CategoriesMaster", "Bussioness")
                        .WithMany("BussionessOfFamilyMember")
                        .HasForeignKey("BussionessId");

                    b.HasOne("Parivar.Data.DbModel.CategoriesMaster", "Education")
                        .WithMany("EducationOfFamilyMember")
                    ...
                    b.HasOne("Parivar.Data.DbModel.CategoriesMaster", "RelationShip")
                        .WithMany("RelationShipOfFamilyMember")
                        .HasForeignKey("RelationShipId");

                    b.HasOne("Parivar.Data.DbModel.RelationShipMaster", null)
                        .WithMany("FamilyMemberDetails")
                        .HasForeignKey("RelationShipMasterId");
                });

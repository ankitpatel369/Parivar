namespace Parivar.Utility.Common
{
    public static class GlobalConstant
    {
        ...
        public const string DefaultProjectName = "Parivar";
        ...
        //manage Organisation
        public const string EmailSuccessfullySubscribe = "Email is successfully subscribe.";
        public const string EmailAlreadySubscribe = "Email is already subscribe.";
        public const string OrganisationCreated = "Organisation Created.";
        public const string Activated = "Organisation activated.";
        public const string DeActivated = "Organisation deactivated.";
        public const string AcceptOrganisation = "Organisation request accepted.";
        public const string RejectOrganisation = "Organisation request rejected.";
